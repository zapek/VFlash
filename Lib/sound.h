...
// 
///////////////////////////////////////////////////////////////
// $Id: sound.h,v 1.5 2004/04/15 19:33:10 zapek Exp $
#ifndef _SOUND_H_
#define _SOUND_H_
...
public:
	...
	char		*setNbSamples(long n, long *size); /* zapek: change */
...
static  void *         ctx;
static  char *		 buffer[2];	   // DMA buffer
...
public:
	SoundMixer(struct FlashPrefs *);
	~SoundMixer();

	void		 startSound(Sound *sound, long loopcnt);  // Register a sound to be played
