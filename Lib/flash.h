...
//
///////////////////////////////////////////////////////////// */
// $Id: flash.h,v 1.2 2004/01/22 17:48:32 zapek Exp $
#ifndef _FLASH_H_
#define _FLASH_H_
...
extern void FlashSoundInit(FlashHandle fh, struct FlashPrefs *vfp);
extern int  FlashParse(FlashHandle fh, int level, char *data, long size);
extern long FlashExec(FlashHandle fh, long flag, FlashEvent *fe, struct unixtimeval *wakeDate);
