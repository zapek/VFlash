...
// $Id: flash.cc,v 1.1.1.1 2002/10/07 12:52:21 zapek Exp $
...
#ifdef RCSID
static char *rcsid = "$Id: flash.cc,v 1.1.1.1 2002/10/07 12:52:21 zapek Exp $";
#endif
...
void
FlashSoundInit(FlashHandle flashHandle, struct FlashPrefs *vfp)
{
	FlashMovie *fh;

	fh = (FlashMovie *)flashHandle;

	fh->sm = new SoundMixer(vfp);
}
...
FlashExec(FlashHandle flashHandle, long flag,
		  FlashEvent *fe, struct unixtimeval *wakeDate)
{
	FlashMovie *fh;
	long wakeUp = 0;
